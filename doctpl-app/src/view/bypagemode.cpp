...
void ByPageMode::adjustCurrentField(TemplateLayout *tl, View *tv) {
...
/**
  ...
  */
void ByPageMode::adjustCurrentPage(TemplateLayout *tl, View *tv) {
...
void ByPageMode::processWheelEvent(TemplateLayout *tl, View *tv,
    QWheelEvent *event)
{
    ViewMode::processWheelEvent(tl, tv, event);
}

void ByPageMode::processResizeEvent(TemplateLayout *tl, View *tv,
    QResizeEvent *event)
{
    if (tl && tv->currentPage()) {
        ...
        ViewMode::processResizeEvent(tl, tv, event);
}

void ByPageMode::processScrollByEvent(TemplateLayout *tl, View *tv,
    int dx, int dy)
{
    //
    if (tl) {
        ...
        ViewMode::processScrollByEvent(tl, tv, dx, dy);
}

void ByPageMode::processDoubleClickEvent(TemplateLayout *tl, View *tv,
    QMouseEvent *event)
{
...
void ByPageMode::init(TemplateLayout *tl, View *tv) {
